            ...
            <div className="h-full">
                <div className="relative flex flex-col bg-card h-full rounded-[7px] shadow-[--soft-shadow] transition-all duration-300" style={{width: isOpen ? '100%' : '5rem'}} >
                    ...
                    <div className="flex flex-col h-full justify-between">
                        <ul className="px-2 pt-16 flex flex-col">
                            <li className="flex items-center rounded-[10px] cursor-pointer hover:bg-popover transition-all duration-200 px-5 py-2"><Link to={''}><Dashboard className="w-6.5" /></Link><span className="pl-5 whitespace-nowrap transition-all duration-200" style={{opacity: isOpen ? '1':'0' }}>Home</span></li>
